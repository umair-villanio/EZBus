...
<div class="navbar">
  ...
  <a href="../home.php" id="website" style="float:left">eZBus</a>
      ...
      <div class="leftnav">
        ...
        <ul>
          ...
          <li><a href="adminDashboard.php" >Dashboard</a></li>
            ...
            <li><a href="refund.php" class="active">Refund</a></li>
    ...
    <div style="margin-left:17%; margin-top: 50px;padding:1px 16px;height:1000px;">
        ...
        $sql1 = "SELECT * FROM refund;";
        $result = $con->query($sql1);


        if (isset($_POST['searchbtn'])) {
            $search = $_POST['search'];
            $sql2 = "SELECT * FROM refund WHERE Refund_id LIKE  '%$search%' OR Booking_id LIKE  '%$search%' OR Confirmation_status LIKE '%$search%'";
            tablerefund($sql2);
        }
        else {
